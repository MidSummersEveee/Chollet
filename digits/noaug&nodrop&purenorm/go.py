...
# train_generator = datagen.flow(partial_x_train, partial_y_train, batch_size=32)


print("Learning...")
history = model.fit(x_train, y_train, epochs=14, batch_size=16)
...
write_preds(preds, "predc-keras-convnet-noaug&nodrop&purenorm.csv")